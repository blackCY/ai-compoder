...
export function StageDetailPanel({
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed right-0 top-0 h-full w-full max-w-2xl bg-black backdrop-blur-3xl border-l border-white/10 shadow-[-20px_0_50px_-10px_rgba(0,0,0,0.5)] z-50 overflow-hidden flex flex-col animate-in slide-in-from-right duration-300 ease-in-out">
